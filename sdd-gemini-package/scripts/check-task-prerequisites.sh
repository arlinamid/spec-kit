...
if $JSON_MODE; then
    ...
    [[ -f "$SECURITY_RESEARCH" ]] && docs+=("security-research.md")
    [[ -f "$DATA_MODEL" ]] && docs+=("data-model.md")
    [[ -f "$SECURITY_ARCHITECTURE" ]] && docs+=("security-architecture.md")
    ...
    check_file "$SECURITY_RESEARCH" "security-research.md"
    check_file "$DATA_MODEL" "data-model.md"
    check_file "$SECURITY_ARCHITECTURE" "security-architecture.md"
